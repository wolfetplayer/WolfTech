...
// q_shared.h declares these (used by the shared botlib/qcommon code bspc now links against);
// bspc never linked q_shared.c, so provide minimal standalone implementations here instead.
int Q_vsnprintf( char *str, size_t size, const char *format, va_list ap ) {
	return vsnprintf( str, size, format, ap );
} //end of the function Q_vsnprintf
...
int Com_sprintf( char *dest, int size, const char *fmt, ... ) {
	...
	return len;
} //end of the function Com_sprintf
